...
namespace Fmacias.TplQueue.Contracts
{
    public interface IJobFactory
    {
        ...
        IJob CreateJob<T>(Action<CancellationToken, T> action, T arg, string name = "");
        IJob CreateJob<T>(Func<CancellationToken, T, Task> func, T arg, string name = "");
        ...
        IJob CreateJob<T1, T2>(Action<CancellationToken, T1, T2> action, T1 arg1, T2 arg2, string name = "");
        IJob CreateJob<T1, T2>(Func<CancellationToken, T1, T2, Task> func, T1 arg1, T2 arg2, string name = "");
